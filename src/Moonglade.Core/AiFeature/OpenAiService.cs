    ...
    IConfiguration configuration)
{
    ...
    private const string AbstractPrompt =
        "我刚刚写完了一篇博客，但是我需要为这篇博客写一个摘要。摘要需要能够简明概括这篇博客讲了什么，并且保留一些有趣的问题来吸引读者来阅读、启发读者思考。写一篇好的摘要还需要试图打开读者的思想，让人忍不住对文章的内容进行畅想从而阅读全文，并且能够借文章的内容延伸思考，别忘了摘要的最后可以提出问题吸引读者自己找到答案。我想让你来帮我完成这篇摘要。首先你需要判断文章的编写语言再开始编写摘要。摘要应当讨论文章本身，不要出现'作者'。摘要的长度应当非常精简，在300字左右，不要超过600字。你的摘要需要和下面博文的语言相同，例如：如果博文是中文，使用中文摘要。如果博文是英文，则使用英文进行摘要。无需问候和署名。不要使用markdown和分段。你是在做摘要而不要重新反复复述文章的内容。只输出写好的摘要，不要输出其它内容。原本的博客文章如下：";
