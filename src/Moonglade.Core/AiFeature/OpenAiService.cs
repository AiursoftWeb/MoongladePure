    ...
    IConfiguration configuration)
{
    ...
    private const string WorkTagsPrompt =
        "好了，根据上面的文章，现在开始你的 Tag 工作吧！别忘了，Tag 的数量应当为六个，不要多也不要少。Tag 的长度应当非常精简，不要超过 20 个字符。你的 Tag 需要使用英文。注意，你输出的 Tags 必须按照如下格式：<tag1>some-tag</tag1>, <tag2>some-tag</tag2>, <tag3>some-tag</tag3>, <tag4>some-tag</tag4>, <tag5>some-tag</tag5>, <tag6>some-tag</tag6>";
    ...
    public Task<string[]> GenerateTags(string trackedPostPostContent)
    {
