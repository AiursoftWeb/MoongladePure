...
namespace MoongladePure.Core.AiFeature
{
    public class OpenAiService
    {
        ...
        private const string _abstractPrompt =
            "我刚刚写完了一篇博客，但是我需要为这篇博客写一个摘要。摘要需要能够简明概括这篇博客讲了什么，并且保留一些有趣的问题来吸引读者来阅读。写一篇好的摘要还需要试图打开读者的思想，让人忍不住对文章的内容进行畅想从而阅读全文。我想让你来帮我完成这篇摘要。摘要的长度应当在370字左右，不要超过400字。摘要使用的语言应当和博客本身使用的语言相同，也就是说：如果博客是英文，则编写英文摘要；如果博客是中文，则编写中文摘要。无需问候和署名。只输出写好的摘要，不要输出其它内容。原本的博客文章如下：";
