    ...
    IConfiguration configuration)
{
    ...
    private Task<CompletionData> Ask(string content, string prompt)
    {
        return chatClient.AskString(_model, prompt, content);
    }
}